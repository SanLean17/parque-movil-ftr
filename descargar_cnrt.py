...
def descargar_empresa(page, codigo_empresa):
    ...
    try:
        ...
        # Algunas páginas hacen consultas AJAX
        # y no llegan a estado networkidle.
        pass
    ...
    if boton_exportar is None:
        ...
        page.screenshot(
            path=(
                f"cnrt_error_{codigo_empresa}.png"
            ),
            full_page=True
        )
    ...
    if archivo_destino.stat().st_size == 0:
        ...
        raise RuntimeError(
            f"El CSV {archivo_destino} está vacío."
        )
